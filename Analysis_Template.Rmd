...
```{r, fig.cap="Nonmetric multidimensional scaling (NMDS) plot, using the Bray-Curtis dissimilarity coefficient."}
...
#Check assumptions of linear regression model (regular, mixed model or generalized model) with performance library and MuMIn library
